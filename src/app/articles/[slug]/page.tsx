  ...
  if (!article) return (
    <div className="flex justify-center items-center min-h-[70vh]">
      <div className="flex flex-col items-center">
        ...
        <p className="text-zinc-500 font-medium text-sm tracking-wide">Chargement de l'article...</p>
      </div>
    </div>
  );
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 py-12 md:py-20">
      ...
      <section className="mb-16">
        ...
        {commentaires.length > 0 ? (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-zinc-800 text-sm sm:text-base leading-relaxed break-words">{comment.texte}</p>
          ...
          <div className="bg-[#FAFAFC] border border-zinc-200 rounded-2xl p-10 text-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 mx-auto text-zinc-400 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            </svg>
            <p className="text-zinc-800 font-medium text-sm">Aucun commentaire pour le moment.</p>
            <p className="text-zinc-500 text-xs mt-1">Soyez le premier à réagir à cet article.</p>
          </div>
        )}
      </section>
      ...
      <section className="bg-[#FAFAFC] rounded-2xl p-6 sm:p-8 border border-zinc-200/80 shadow-2xs">
        <h3 className="text-lg font-bold text-zinc-900 mb-6 tracking-tight">Laisser un commentaire</h3>
