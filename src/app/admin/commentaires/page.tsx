    ...
    <div className="space-y-8">
      ...
      {loading ? (
        <div className="flex items-center gap-3 py-12">
          ...
          <p className="text-zinc-500 text-sm font-medium">Chargement des commentaires...</p>
        </div>
        ...
        <div className="bg-[#FAFAFC] border border-zinc-200 rounded-2xl p-12 text-center">
          ...
          <p className="text-zinc-900 font-semibold text-lg">Aucun commentaire trouvé.</p>
          <p className="text-zinc-500 text-sm mt-1">Les réactions de vos lecteurs apparaîtront ici.</p>
        </div>
      ) : (
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-zinc-100 text-sm">
                {commentaires.map((comment) => (
                  <tr key={comment.id} className="hover:bg-zinc-50/60 transition-colors">
