...
export default async function Home() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      {/* Section d'accueil */}
      <div className="bg-[#FAFAFC] border border-zinc-200/80 rounded-2xl p-8 sm:p-12 mb-16 shadow-xs">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-zinc-900 mb-6 tracking-tight">
          Bienvenue sur BARADINE's Medical Blog
        </h1>

        <div className="max-w-none text-zinc-600 leading-relaxed space-y-5 text-base sm:text-lg">
          ...
          <div className="pt-4">
            <h2 className="text-xl sm:text-2xl font-bold text-zinc-900 mb-6 tracking-tight">
              Notre approche
            </h2>

            <ul className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <li className="bg-white p-5 rounded-xl border border-zinc-200/70 shadow-2xs flex flex-col justify-between">
                <div className="w-8 h-8 rounded-lg bg-zinc-100 text-zinc-900 flex items-center justify-center mb-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
                    fill="none"
          ...
          <div className="bg-white p-6 rounded-xl border-l-4 border-zinc-900 border-y border-r border-zinc-200/70 shadow-2xs mt-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold text-zinc-900 text-sm uppercase tracking-wider mb-1">
        ...
        {articles.length === 0 ? (
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((article: Article) => (
              <li
                key={article.id}
                className="group bg-white border border-zinc-200/80 rounded-2xl overflow-hidden shadow-xs hover:shadow-xl transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  <div className="relative overflow-hidden bg-zinc-100 aspect-[16/10]">
                    ...
                    {article.categorie?.nom && (
                      <span className="absolute top-3 right-3 bg-zinc-900/90 backdrop-blur-md text-white text-[11px] uppercase tracking-wider px-3 py-1 rounded-full font-medium shadow-sm">
                        {article.categorie.nom}
                      </span>
                    )}
                  </div>
                  <div className="p-6">
                    <h3 className="text-lg font-bold text-zinc-900 mb-2.5 group-hover:text-zinc-600 transition-colors leading-snug">
                      {article.titre}
                    </h3>
                ...
                <div className="px-6 pb-6 pt-0 mt-auto">
                  <div className="flex items-center justify-between pt-4 border-t border-zinc-100">
                    <a
                      ...
                      className="inline-flex items-center text-xs font-bold uppercase tracking-wider text-zinc-900 group-hover:underline"
                    >
                      Lire la suite
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
